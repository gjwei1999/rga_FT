...
class Histogram {
 protected:
  ...
  TH1D_ptr Q2_thrown;
  TH1D_ptr invmass_Ppip_twoPi_thrown; 
  TH1D_ptr invmass_Ppim_twoPi_thrown;
  TH1D_ptr invmass_pippim_twoPi_thrown;
